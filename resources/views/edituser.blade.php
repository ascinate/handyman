...
<section class="float-start w-100 dashboard lg-body01">
    <div class="container">
        <div class="inside-tops m-height d-inline-block w-100">
           ...
           <form method="POST" action="{{ route('updateuser', ['id' => $user->id]) }}" enctype="multipart/form-data" class="forms-rgister fom-controls px-4 mt-5">
                @csrf
                ...
                <div class="comon-fomr01">
                    ...
                    <div class="col">
                        ...
                        <input type="text" class="form-control" name="street" id="street" value="{{ $user->street }}" />
                        </div>
                    </div>
                    <div class="col">
                        <div class="form-group">
                    ...
                    <div class="col">
                        ...
                        <input type="text" class="form-control" name="zipcode" id="zip" value="{{ $user->zipcode }}" />
                        </div>
                    </div>
                    </div>
                </div>
