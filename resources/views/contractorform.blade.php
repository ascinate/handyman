                                ...
                                <div class="form-group">
                                    ...
                                    <div class="flex-wrap d-flex no-garps1 align-itmes-center">
                                        <div class="form-check">
                                            <input class="form-check-input" name="service_freq_preferred_day[]" type="checkbox" value="Monday" id="dasy1" required>
                                            <label class="form-check-label" for="dasy1">
                                                Monday
                                            </label>
                                          </div>
                                          <div class="form-check">
                                            <input class="form-check-input" name="service_freq_preferred_day[]" type="checkbox" value="Tuesday" id="dasy2" required>
                                            <label class="form-check-label" for="dasy2">
                                                Tuesday
                                            </label>
                                          </div>
                                          <div class="form-check">
                                            <input class="form-check-input" name="service_freq_preferred_day[]" type="checkbox" value="Wednesday" id="dasy3" required>
                                            <label class="form-check-label" for="dasy3">
                                            Wednesday
                                            </label>
                                          </div>
                                          <div class="form-check">
                                            <input class="form-check-input" name="service_freq_preferred_day[]" type="checkbox" value="Thursday" id="dasy4" required>
                                            <label class="form-check-label" for="dasy4">
                                            Thursday
                                            </label>
                                          </div>
                                          <div class="form-check">
                                            <input class="form-check-input" name="service_freq_preferred_day[]" type="checkbox" value="Friday" id="dasy5" required>
                                            <label class="form-check-label" for="dasy5">
                                            Friday
                                            </label>
                                          </div>
                                          <div class="form-check">
                                            <input class="form-check-input" name="service_freq_preferred_day[]" type="checkbox" value="Saturday" id="dasy6">
                                            <label class="form-check-label" for="dasy6">
                                            Saturday
                                            </label>
                                          </div>
                                          <div class="form-check">
                                            <input class="form-check-input" name="service_freq_preferred_day[]" type="checkbox" value="Sunday" id="dasy7">
