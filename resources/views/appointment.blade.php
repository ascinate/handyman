                          ...
                          @foreach ($contractors as $contractor)
                            <div class="col">
                              ...
                              <div class="itesm-divs position-relative crm-checks contrs-div one-03 form-check">
                                ...
                                <input class="form-check-input" type="radio" name="contructor_id" id="contt{{ $contractor->id }}" value="{{ $contractor->id }}" required>
                                <label class="form-check-label" for="contt{{ $contractor->id }}">
