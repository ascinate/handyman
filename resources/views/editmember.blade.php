        ...
        <div class="inside-tops m-height d-inline-block w-100">
           ...
           <div class="px-4 forms-rgister fom-controls">
            ...
            <section class="pt-5 multi-step-form">
                ...
                <form action="{{ URL::to('/member/update/' . $familyMember->id) }}" method="post">
                 @csrf
                        ...
                        <div class="row row-cols-1 gy-4 row-cols-lg-2">
                            ...
                            <div class="col">
                               <div class="form-group">
                                   ...
                                   <input type="password" class="form-control" name="password" id="password" value="{{ $familyMember->password }}" required/>
                               </div>
                            </div>
